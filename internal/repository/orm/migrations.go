...
var MigrationTableColumns = struct {
	...
	ID:        "migrations.id",
	VersionID: "migrations.version_id",
	IsApplied: "migrations.is_applied",
	Tstamp:    "migrations.tstamp",
}
...
var MigrationWhere = struct {
	...
	ID:        whereHelperint{field: "\"migrations\".\"id\""},
	VersionID: whereHelperint64{field: "\"migrations\".\"version_id\""},
	IsApplied: whereHelperbool{field: "\"migrations\".\"is_applied\""},
	Tstamp:    whereHelpertime_Time{field: "\"migrations\".\"tstamp\""},
}
...
var (
	migrationAllColumns            = []string{"id", "version_id", "is_applied", "tstamp"}
	migrationColumnsWithoutDefault = []string{"version_id", "is_applied"}
	migrationColumnsWithDefault    = []string{"id", "tstamp"}
...
func (q migrationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Migration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for migrations")
	}
...
func (q migrationQuery) All(ctx context.Context, exec boil.ContextExecutor) (MigrationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "orm: failed to assign all query results to Migration slice")
	}
...
func (q migrationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count migrations rows")
	}
...
func (q migrationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if migrations exists")
	}
...
func FindMigration(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Migration, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from migrations")
	}

	if err = migrationObj.doAfterSelectHooks(ctx, exec); err != nil {
...
func (o *Migration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no migrations provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into migrations")
	}
...
func (o *Migration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update migrations, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update migrations row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for migrations")
	}
...
func (q migrationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for migrations")
	}
...
func (o MigrationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all in migration slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected all in update all migration")
	}
	return rowsAff, nil
}
...
func (o *Migration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("orm: no migrations provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert migrations, could not build update column list")
		}

		ret := strmangle.SetComplement(migrationAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(migrationPrimaryKeyColumns) == 0 {
				return errors.New("orm: unable to upsert migrations, could not build conflict column list")
			}

			conflict = make([]string, len(migrationPrimaryKeyColumns))
			copy(conflict, migrationPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"migrations\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert migrations")
	}
...
func (o *Migration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("orm: no Migration provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for migrations")
	}
...
func (q migrationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("orm: no migrationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from migrations")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for migrations")
	}
...
func (o MigrationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from migration slice")
	}
...
func (o *MigrationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to reload all in MigrationSlice")
	}
...
func MigrationExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if migrations exists")
	}
...
func (o *Migration) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
