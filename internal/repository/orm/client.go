...
type clientR struct {
	AuthRequests AuthRequestSlice `boil:"AuthRequests" json:"AuthRequests" toml:"AuthRequests" yaml:"AuthRequests"`
}
...
func (o *Client) GetAuthRequests() AuthRequestSlice {
	if o == nil {
		return nil
	}

	return o.R.GetAuthRequests()
}

func (r *clientR) GetAuthRequests() AuthRequestSlice {
	if r == nil {
		return nil
	}

	return r.AuthRequests
}
...
func (q clientQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Client, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: failed to execute a one query for client")
	}
...
func (q clientQuery) All(ctx context.Context, exec boil.ContextExecutor) (ClientSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "orm: failed to assign all query results to Client slice")
	}
...
func (q clientQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to count client rows")
	}
...
func (q clientQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "orm: failed to check if client exists")
	}

	return count > 0, nil
}

// AuthRequests retrieves all the auth_request's AuthRequests with an executor.
func (o *Client) AuthRequests(mods ...qm.QueryMod) authRequestQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"auth_request\".\"client_id\"=?", o.ID),
	)

	return AuthRequests(queryMods...)
}

// LoadAuthRequests allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (clientL) LoadAuthRequests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeClient any, mods queries.Applicator) error {
	var slice []*Client
	var object *Client
	...
	query := NewQuery(
		qm.From(`auth_request`),
		qm.WhereIn(`auth_request.client_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load auth_request")
	}

	var resultSlice []*AuthRequest
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice auth_request")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on auth_request")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for auth_request")
	}
	...
	if singular {
		object.R.AuthRequests = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &authRequestR{}
			}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.ClientID {
				local.R.AuthRequests = append(local.R.AuthRequests, foreign)
				if foreign.R == nil {
					foreign.R = &authRequestR{}
				}
...
// AddAuthRequests adds the given related objects to the existing relationships
// of the client, optionally inserting them as new records.
// Appends related to o.R.AuthRequests.
// Sets related.R.Client appropriately.
func (o *Client) AddAuthRequests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*AuthRequest) error {
	var err error
	...
	if o.R == nil {
		o.R = &clientR{
			AuthRequests: related,
		}
	} else {
		o.R.AuthRequests = append(o.R.AuthRequests, related...)
	}
...
func FindClient(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Client, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "orm: unable to select from client")
	}
...
func (o *Client) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("orm: no client provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to insert into client")
	}
...
func (o *Client) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("orm: unable to update client, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update client row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by update for client")
	}
...
func (q clientQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all for client")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected for client")
	}
...
func (o ClientSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to update all in client slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to retrieve rows affected all in update all client")
	}
	return rowsAff, nil
}
...
func (o *Client) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("orm: no client provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("orm: unable to upsert client, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(clientPrimaryKeyColumns) == 0 {
				return errors.New("orm: unable to upsert client, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert client")
	}
...
func (o *Client) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("orm: no Client provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete from client")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by delete for client")
	}
...
func (q clientQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("orm: no clientQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from client")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "orm: failed to get rows affected by deleteall for client")
	}
...
func (o ClientSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "orm: unable to delete all from client slice")
	}
...
func (o *ClientSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to reload all in ClientSlice")
	}
...
func ClientExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "orm: unable to check if client exists")
	}
